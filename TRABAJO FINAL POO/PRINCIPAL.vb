Public Class PRINCIPAL
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        MessageBox.Show("PACHECO VARGAS ANTHONY ROBERTO" + vbCrLf + "RAMOS CORDOVA JOEL ISAAC" + vbCrLf + "ANTEZANO MEJIA JOSE LUIS", "DESARROLADO POR: ", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
